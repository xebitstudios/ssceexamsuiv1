(function() {
    ...
    /* @ngInject */
    function SscephysicsatemplateController($scope, $log, $location, $controller, $rootScope, ConfigService, HeaderService, ApiService, TimerService, growl, $timeout) {
        ...
        $scope.getNext = function() {
            // console.log('_.keys($scope.qtt).length: ' + _.keys($scope.qtt).length);
            // console.log('$scope.qqt.Qval:' + $scope.qqt.Qval);
