	...
	angular
		...
		function ConfigService($rootScope) {
			...
			function setUrl(val) {
				...
				var qaurlset = 'https://150.250.242.52:6040'; // 'https://150.250.242.189:6040'
			...
			function getApiBaseRoute() {
				...
				// console.log('$(location).attr("href") is: ');
				// console.log($(location).attr('href'));
				// console.log('$rootScope.junctionpath is: ');
				// console.log($rootScope.junctionpath);
