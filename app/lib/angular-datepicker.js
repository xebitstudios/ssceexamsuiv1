...
(function withAngular(angular, navigator) {
  ...
  var A_DAY_IN_MILLISECONDS = 86400000
      ...
      return [
        '<div class="datepicker-calendar-header">',
          '<div class="datepicker-calendar-header-left">',
            '<a class="datepicker-calendar-month-button" href="javascript:void(0)" ng-class="{\'datepicker-item-hidden\': !willPrevMonthBeSelectable()}" ng-click="prevMonth()" title="{{ buttonPrevTitle }}">',
              prevButton,
            '</a>',
          '</div>',
          '<div class="datepicker-calendar-header-middle datepicker-calendar-month">',
            ...
            '<a href="javascript:void(0)" ng-click="paginateYears(year); showYearsPagination = !showYearsPagination;">',
              '<span>',
                '{{year}}',
                '<i ng-class="{\'datepicker-calendar-header-closed-pagination\': !showYearsPagination, \'datepicker-calendar-header-opened-pagination\': showYearsPagination}"></i>',
              '</span>',
            '</a>',
          '</div>',
          '<div class="datepicker-calendar-header-right">',
          '<a class="datepicker-calendar-month-button" ng-class="{\'datepicker-item-hidden\': !willNextMonthBeSelectable()}" href="javascript:void(0)" ng-click="nextMonth()" title="{{ buttonNextTitle }}">',
            nextButton,
          '</a>',
          '</div>',
        '</div>'
      ...
      return [
        '<div class="datepicker-calendar-header" ng-show="showYearsPagination">',
          '<div class="datepicker-calendar-years-pagination">',
            '<a ng-class="{\'datepicker-active\': y === year, \'datepicker-disabled\': !isSelectableMaxYear(y) || !isSelectableMinYear(y)}" href="javascript:void(0)" ng-click="setNewYear(y)" ng-repeat="y in paginationYears">',
              '{{y}}',
            '</a>',
          '</div>',
          '<div class="datepicker-calendar-years-pagination-pages">',
            '<a href="javascript:void(0)" ng-click="paginateYears(paginationYears[0])" ng-class="{\'datepicker-item-hidden\': paginationYearsPrevDisabled}">',
              prevButton,
            '</a>',
            '<a href="javascript:void(0)" ng-click="paginateYears(paginationYears[paginationYears.length -1 ])" ng-class="{\'datepicker-item-hidden\': paginationYearsNextDisabled}">',
              nextButton,
            '</a>',
          '</div>',
        '</div>'
    ...
    , generateDays = function generateDays() {
      ...
      return [
        '<div class="datepicker-calendar-body">',
          '<a href="javascript:void(0)" ng-repeat="px in prevMonthDays" class="datepicker-calendar-day datepicker-disabled">',
            '{{px}}',
          '</a>',
          '<a href="javascript:void(0)" ng-repeat="item in days" ng-click="setDatepickerDay(item)" ng-class="{\'datepicker-active\': day === item, \'datepicker-disabled\': !isSelectableMinDate(year + \'/\' + monthNumber + \'/\' + item ) || !isSelectableMaxDate(year + \'/\' + monthNumber + \'/\' + item) || !isSelectableDate(monthNumber, year, item)}" class="datepicker-calendar-day">',
            '{{item}}',
          '</a>',
          '<a href="javascript:void(0)" ng-repeat="nx in nextMonthDays" class="datepicker-calendar-day datepicker-disabled">',
            '{{nx}}',
          '</a>',
        '</div>'
      ];
    ...
    , generateHtmlTemplate = function generateHtmlTemplate(prevButton, nextButton) {
      ...
      var toReturn = [
        '<div class="datepicker-calendar {{datepickerClass}} {{datepickerID}} {{classForToggle}}" ng-blur="hideCalendar()">',
        '</div>'
      ]
